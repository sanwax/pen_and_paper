...
namespace dds
{
    ...
    void
    DataWriter::addTopic(const dds::TopicType iType)
    {
    ...
    void
    DataWriter::addTopic(std::unique_ptr<dds::AbstractTopic>& pTopic)
    {
            if (!pTopic)
            {
    ...
    void
    DataWriter::publish(std::unique_ptr<dds::AbstractTopic>& pTopic)
    {
    ...
    void
    DataWriter::deleteTopic(std::unique_ptr<dds::AbstractTopic>& pTopic)
    {
            if (!pTopic)
            {
                    throw Exception("Unexpected object: nullptr. Unable to obtain topic type.");
    ...
    void
    DataWriter::deleteTopic(const dds::TopicType iType)
    {
