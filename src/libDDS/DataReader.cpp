...
namespace dds
{
    ...
    /*virtual*/
    void
    DataReader::handleEvent(const dds::TopicType type,std::shared_ptr<const dds::AbstractTopic> pTopic,const dds::Operation operation)
    {
    ...
    /*virtual*/
    void
    DataReader::subscribe(const dds::TopicType type,Callback callback)
    {
    ...
    /*virtual*/
    void
    DataReader::unsubscribe(const dds::TopicType type)
    {
            if (mCallbackMap.find(type)!=mCallbackMap.end())
            {
